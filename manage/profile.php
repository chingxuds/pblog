                        ...
                        method="post">
                            ...
                            <table>
                                <tr>
                                    ...
                                    value="<?=isset($_SESSION["user_profile"]['lastname']) ? $_SESSION["user_profile"]['lastname'] : "" ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    value="<?=isset($_SESSION["user_profile"]['firstname']) ? $_SESSION["user_profile"]['firstname'] : "" ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    value="<?=isset($_SESSION["user_profile"]['nicename']) ? $_SESSION["user_profile"]['nicename'] : "" ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="input-label" style="width: 100px"><span>显示名</span></td>
                                    <td>
                                    <select class="input-text" style="width: 408px;"
                                ...
                                <tr>
                                    ...
                                    value="<?=isset($_SESSION["user_profile"]['email']) ? $_SESSION["user_profile"]['email'] : "" ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    value="<?=isset($_SESSION["user_profile"]['tel']) ? $_SESSION["user_profile"]['tel'] : "" ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    <input type="button" style="width: 103px;"
                                    id="button_update" value="更新" />
                                    </td>
                                </tr>
                            </table>
                        </form>
